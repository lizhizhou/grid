...
# Tue Jun 18 21:57:54 CST 2013
# DO NOT MODIFY


# 
# qsys_device "qsys_device" v1.0
# Zhizhou Li 2013.06.18.21:57:54
...
add_fileset_file qsys_device.v VERILOG PATH qsys_root/qsys_root/qsys_device.v
...
add_interface_port ctrl avs_ctrl_address address Input "(address_size) - (0) + 1"
...
add_interface_port conduit_end device_reset export Output 1
add_interface_port conduit_end device_clk export Output 1
add_interface_port conduit_end device_writedata export Output 16
add_interface_port conduit_end device_byteenable export Output 2
add_interface_port conduit_end device_write export Output 1
add_interface_port conduit_end device_read export Output 1
add_interface_port conduit_end device_waitrequest export Input 1
add_interface_port conduit_end device_readdata export Input 16
add_interface_port conduit_end device_address export Output "(address_size) - (0) + 1"
